          ...
          <div className="row">
              <div className="col-12 d-flex">
                  <div className="col-6 tucan pe-2 image-container">
                      <img className="tucan" src="public/imagenes/tucan.jpg" alt="" />
                  ...
                  <div className="col-6">
                      <div className="col-12 trespalos image-container">
                        <img className="w-100 trespalos" src="public/imagenes/trespalos.jpg" alt="" />
                        <div className="overlay2">
                          <a href="/SobreNosotros" className="overlay-text">Sobre nosotros</a>
                        </div>
                      </div>
                      <div className="col-12 volar image-container">
                        <img className="w-100 volar" src="public/imagenes/volar.jpg" alt="" />
                        <div className="overlay2">
